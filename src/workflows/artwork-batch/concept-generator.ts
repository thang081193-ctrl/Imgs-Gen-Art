...
//
// Session #15: deriveSeed was promoted to src/core/shared/rand.ts so all 4
// workflows share the exact same hash; we re-export here to keep the
// historical artwork-batch import surface stable.
...
export { deriveSeed } from "@/core/shared/rand"
